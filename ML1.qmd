...
One limitation that we must take into account is that, even if we have a big data set, it can also be a constrain for the application of
machine learning algorithms. It is also important to note that we have a lot of observations for limited size of samples; we are victims
